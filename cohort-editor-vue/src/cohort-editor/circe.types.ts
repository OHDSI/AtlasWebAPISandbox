...
export const DeviceExposureSchema = CriteriaBaseSchema.extend({
  ...
  DeviceSourceConcept: ConceptArraySchema.optional(),
  DeviceSourceConceptCS: ConceptSetSelectionSchema.optional(),
  DeviceSourceConceptExclude: z.boolean().optional(),
...
export const DrugExposureSchema = CriteriaBaseSchema.extend({
  ...
  Dose: NumericRangeSchema.optional(),
...
export const MeasurementSchema = CriteriaBaseSchema.extend({
  ...
  Value: NumericRangeSchema.optional(),
  ...
  UnitExclude: z.boolean().optional(),
...
export const ObservationSchema = CriteriaBaseSchema.extend({
  ...
  ValueAsConcept: ConceptArraySchema.optional(),
  ValueAsConceptCS: ConceptSetSelectionSchema.optional(),
  ValueAsConceptExclude: z.boolean().optional(),
  QualifierConcept: ConceptArraySchema.optional(),
  QualifierConceptCS: ConceptSetSelectionSchema.optional(),
  QualifierConceptExclude: z.boolean().optional(),
  ObservationSourceConcept: ConceptArraySchema.optional(),
  ObservationSourceConceptCS: ConceptSetSelectionSchema.optional(),
  ObservationSourceConceptExclude: z.boolean().optional(),
})
...
export const ObservationPeriodSchema = CriteriaBaseSchema.extend({
  ...
  PeriodTypeExclude: z.boolean().optional(),
})
...
export const PayerPlanPeriodSchema = CriteriaBaseSchema.extend({
  ...
  PeriodStartDate: DateRangeSchema.optional(),
  PeriodEndDate: DateRangeSchema.optional(),
  UserDefinedPeriod: z.boolean().optional(),
  PeriodLength: NumericRangeSchema.optional(),
  PayerConcept: ConceptArraySchema.optional(),
  PayerConceptCS: ConceptSetSelectionSchema.optional(),
  PayerConceptExclude: z.boolean().optional(),
  PlanConcept: ConceptArraySchema.optional(),
  PlanConceptCS: ConceptSetSelectionSchema.optional(),
  PlanConceptExclude: z.boolean().optional(),
  SponsorConcept: ConceptArraySchema.optional(),
  SponsorConceptCS: ConceptSetSelectionSchema.optional(),
  SponsorConceptExclude: z.boolean().optional(),
})
...
export const ProcedureOccurrenceSchema = CriteriaBaseSchema.extend({
  ...
  ModifierConcept: ConceptArraySchema.optional(),
  ModifierConceptCS: ConceptSetSelectionSchema.optional(),
  ModifierConceptExclude: z.boolean().optional(),
  ProcedureSourceConcept: ConceptArraySchema.optional(),
  ProcedureSourceConceptCS: ConceptSetSelectionSchema.optional(),
  ProcedureSourceConceptExclude: z.boolean().optional(),
})
...
export const SpecimenSchema = CriteriaBaseSchema.extend({
  ...
  SpecimenSourceConcept: ConceptArraySchema.optional(),
  SpecimenSourceConceptCS: ConceptSetSelectionSchema.optional(),
  SpecimenSourceConceptExclude: z.boolean().optional(),
  Unit: ConceptArraySchema.optional(),
  UnitCS: ConceptSetSelectionSchema.optional(),
  UnitExclude: z.boolean().optional(),
  Quantity: NumericRangeSchema.optional(),
...
export const VisitDetailSchema = CriteriaBaseSchema.extend({
  ...
  VisitDetailType: ConceptArraySchema.optional(),
  VisitDetailTypeCS: ConceptSetSelectionSchema.optional(),
  VisitDetailTypeExclude: z.boolean().optional(),
  Provider: ConceptArraySchema.optional(),
  ProviderCS: ConceptSetSelectionSchema.optional(),
  ProviderExclude: z.boolean().optional(),
  VisitDetailSourceConcept: ConceptArraySchema.optional(),
  VisitDetailSourceConceptCS: ConceptSetSelectionSchema.optional(),
  VisitDetailSourceConceptExclude: z.boolean().optional(),
})
...
export const VisitOccurrenceSchema = CriteriaBaseSchema.extend({
  ...
  ProviderCS: ConceptSetSelectionSchema.optional(),
  ProviderExclude: z.boolean().optional(),
  VisitSourceConcept: ConceptArraySchema.optional(),
  VisitSourceConceptCS: ConceptSetSelectionSchema.optional(),
  VisitSourceConceptExclude: z.boolean().optional(),
})
